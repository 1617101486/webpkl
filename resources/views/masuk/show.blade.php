		...
		<div class="col-md-12">
			<div class="panel panel-primary">
			  ...
			  <div class="panel-body">
			  	<form action="{{ route('masuk.show',$masuk->id) }}" method="post" >
			  		<input name="_method" type="hidden" value="PATCH">
        			{{ csrf_field() }}
			  		<div class="form-group {{ $errors->has('no_surat') ? ' has-error' : '' }}">
			  			<label class="control-label">No Surat Masuk</label>	
			  			<input type="number" name="no_surat" class="form-control" value="{{ $masuk->no_surat }}" readonly>
			  		...
			  		<div class="form-group {{ $errors->has('tgl_surat') ? ' has-error' : '' }}">
			  			...
			  			<input type="date" value="{{ $masuk->tgl_surat }}" name="tgl_surat" class="form-control"  readonly>
			  		...
			  		<div class="form-group {{ $errors->has('pengirim') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="pengirim" class="form-control" value="{{ $masuk->pengirim }}" readonly>
			  		...
			  		<div class="form-group {{ $errors->has('perihal') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="perihal" class="form-control" value="{{ $masuk->perihal }}" readonly>
			  		...
			  		<div class="form-group {{ $errors->has('file') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="file" class="form-control" value="{{ $masuk->file }}" readonly>
			  			@if ($errors->has('file'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('id_disposisi') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="id_disposisi" class="form-control" value="{{ $masuk->Disposisi->keterangan }}" readonly>
			  		...
			  		<div class="form-group {{ $errors->has('keterangan') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="keterangan" class="form-control" value="{{ $masuk->keterangan }}" readonly>
